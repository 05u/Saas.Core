...
namespace Saas.Core.Data.Migrations
{
    ...
    [Migration("20230213081108_20230213-2")]
    partial class _202302132
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Saas.Core.Data.Entities.LuckyDrawRecord", b =>
                {
                    ...
                    b.Property<string>("MdmMessageReceiverId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("MdmMessageReceiverId");
            ...
            modelBuilder.Entity("Saas.Core.Data.Entities.LuckyDrawRecord", b =>
                {
                    ...
                    b.HasOne("Saas.Core.Data.Entities.MdmMessageReceiver", "MessageReceiver")
                        .WithMany()
                        .HasForeignKey("MdmMessageReceiverId");
